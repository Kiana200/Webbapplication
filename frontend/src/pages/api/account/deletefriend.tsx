...
import { DeleteFriendBodyApiRequest } from '@/constants/interfaces';

const deleteFriend = async (req: DeleteFriendBodyApiRequest, res: NextApiResponse) => {
    if (req.method === 'DELETE') {
        ...
        try {
            ...
            const apiRes = await axiosClient.delete(`${url}/api/account/delete_friend`, {
                headers: {
