...
const acceptFriendRequest = async (req: FriendRequestBodyApiRequest, res: NextApiResponse) => {
    if (req.method === 'POST') {
        ...
        try {
            ...
            const apiRes = await axiosClient.post(`${url}/api/friend_request/accept`, body, {
                headers: {
